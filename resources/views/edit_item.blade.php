            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm px-8 py-8">
                <form class="space-y-6" action="{{ route('items.update', $itemInstance->instance_id) }}" method="POST">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input
                                type="text" name="id_barang" id="id_barang" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" value="{{ old('id_barang', $itemInstance->id_barang) }}"
                            >
                        </div>
                    </div>
